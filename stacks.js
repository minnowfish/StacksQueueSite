...
//Questions meant to be stored in a file but since file handling doesn't work on pages, I will use a user defined data structure instead
    const questions = [
        {question: "Show what the outcome will be if the following processes are performed on this stack: Push(“Snake Game”)", answer: "+Snake Game", points: 1},
        {question: "Show what the outcome will be if the following processes are performed on this stack: Push(“Penguin”) Pop()", answer: "+Penguin#-", points: 2},
        {question: "Show what the outcome will be if the following processes are performed on this stack: Push(“Cat”), Push(“Capybara”) Pop()", answer: "+Cat#+Capybara#-", score: 3},
        {question: "Show what the outcome will be if the following processes are performed on this stack: Push(“Pokemon”) Push(“Cat”) Pop() Pop()", answer: "+Pokemon#+Cat#-#-", score: 4},
        {question: "Show what the outcome will be if the following processes are performed on this stack: Push(“Tetris”), Pop(), Push(“Dinosaurs”)", answer: "+Tetris#-#+Dinosaurs", score: 3}
    ];
...
//initialise arrays
        ...
        for (let i = 0 ; i < stack.length ; i++){
            document.getElementById(i+1).innerText = stack[i];
        }
}
